...
var oklch = function (context, args) {
    ...
    var l = isLengthPercentage(tokens[0]) ? tokens[0].number / 100 : tokens[0].number;
    ...
    var a = tokens.length >= 4 ? (isLengthPercentage(tokens[3]) ? getAbsoluteValue(tokens[3], 1) : tokens[3].number) : 1;
