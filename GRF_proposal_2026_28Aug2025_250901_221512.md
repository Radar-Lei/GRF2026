...
The selection of representative countries for this comprehensive study will be guided by a multi-dimensional framework that systematically captures key dimensions relevant to gendered mobility experiences in metro systems. We will employ a carefully curated set of indicators encompassing economic development, gender equality, human development, urbanization patterns, metro system characteristics, and cultural-regional diversity.

The primary indicators include GDP per capita to capture economic capacity and resource availability for metro system development, the Gender Inequality Index (GII) to measure gender disparities across reproductive health, empowerment, and economic dimensions, and the Human Development Index (HDI) to assess overall development levels. Additional indicators include urban population percentage and density to understand urban context and transit demand patterns, metro network characteristics such as length, annual ridership, and system age to account for infrastructure maturity, and geographic distribution across continents to ensure global representation.

The rationale for this comprehensive indicator selection is firmly grounded in the theoretical framework of transport equity and gendered mobility. Economic development indicators provide essential context for understanding the resources available for safety and security measures in metro systems. Gender-specific metrics are particularly crucial as they directly capture the societal context of gender relations that fundamentally shape women's experiences in public spaces. Urbanization metrics help contextualize the transit environment, while metro-specific characteristics ensure meaningful comparability across different systems. The inclusion of cultural-regional diversity acknowledges that gendered mobility barriers manifest differently across various cultural contexts, requiring a globally representative sample that can generate insights applicable across diverse settings.

This multi-indicator approach enables the selection of cities that represent diverse points along the development spectrum, from high-income contexts with advanced gender equality to developing economies with varying levels of gender parity. Such methodological rigor ensures that the resulting dataset will support robust comparative analysis of how gendered mobility barriers evolve across different socioeconomic and cultural environments, ultimately contributing to globally relevant and contextually nuanced understanding of transport equity challenges.
